    ...
    <div className="w-[100%] flex flex-col justify-between  border-[0.5px] border-[#ffffff30] bg h-fit">
      ...
      <div className="flex gap-[5%] my-[3.5vh] ml-[5vw]  l leading-[120%] tracking-tight opacity-45 text-[0.7vw]">
        <div className="desc w-[28%]">
          According to the documents, the teenagers – drafted in from schools
          and technical colleges in and around the central southern city of
          Hengyang – are classified as “interns”, and their teachers
        </div>
        <div className="desc w-[35%]">
          According to the documents, the teenagers – drafted in from schools
          and technical colleges in and around the central southern city of
          Hengyang – are classified as “interns”, and their teachers are paid by
          the factory to accompany them.
        </div>
      </div>{" "}
    </div>
  );
