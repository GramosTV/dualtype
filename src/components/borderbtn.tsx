...
const Borderbtn = () => {
  return (
    <div id="thebtn" className="relative flex items-center z-[1000]  md:scale-100 scale-[75%] justify-center w-[353px] my-[2vh] ">
      <div className="flex  w-full    px-[25px] justify-between">
        
        <div id="textbtn" className="uppercase text-[14px] md:text-sm  text-white z-[10000] "><Text width={true}>why would i need this </Text></div>
        <Image
            alt="arrow"
            width={16}
            height={16}
