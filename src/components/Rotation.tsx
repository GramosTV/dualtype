...
const Rotation: React.FC<RotationProps> = ({
  ...
  return (
    <div className={ ` h-[80vh]  pointer-events-none b relative w-full ${className}`}>
      ...
      <div className="w-[20vw] h-[20vw] bg-white opacity-55 blur-[250px] absolute
      bottom-[20vh] right-[30vw] "></div>
    <div className="text-[16px] ml-[3vw]  font-bold absolute bottom-0  uppercase tracking-tighter">
      ...
      <div
        ...
        className="leading-[90%] blur-[100px] opacity-30 text-[17vw] font-bold  uppercase tracking-[-30px] top-0  ml-[2vw] absolute "
      >
        Watch 
        <br />
        me <br />
...
<div className="w-full h-full flex items-center justify-between absolute z-[-100]">
</div>
      ...
      <div className="">
        ...
        to accompany them. Teachers are asked colleges in and around the central
        southern city of Hengyang – are classified as &quot;internscolleges in and
        around the central southern city of Hengyang – are classified as
        &quot;interns
      </div>
      ...
      <div 
        ref={cursorTextRef}
        className={`absolute pointer-events-none translate-x-[50%] font-bold text-white bg-black/20 border-2 border-[#ffffff34] rounded-full backdrop-blur-lg w-[15vw] h-[15vw] text-sm tracking-wider z-20 ${!isHovering ? 'opacity-0' : ''}`}
        style={{ 
          position: 'absolute',
          zIndex: 10,
        }}
      ...
      <div   ref={TextRef}
        className={`absolute pointer-events-none font-bold text-white flex items-center justify-center  w-[6vw] h-[6vw] text-lg tracking-tighter z-20 ${!isHovering ? 'opacity-0' : ''}`}
        style={{ 
          position: 'absolute',
          zIndex: 20,
        }}>360°</div>
