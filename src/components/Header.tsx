        ...
        ></video>
          ...
          <div className="flex flex-col mt-[12vh] overflow-hidden justify-center items-center gap-[2px]">
           ...
           <Appear delay={0.2}>
            ...
            <Appear delay={0.4}>
              <div className="opacity-45 text-[24px] tracking-tighter text-center mt-[1vh]"> [ Product made for gamers, workers and gay people ] </div>
            </Appear>
            <Appear delay={.8}>
              <Borderbtn />
            </Appear>
          </div>
          <Image width={700} height={700} className="md:hidden block" alt="x" src="/img/Frame 6.png" />
        </>
      )}
    </div>
  );
