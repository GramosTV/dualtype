...
import { Blurout, DownsideAppear, FeaturesAppear, CleanAppear } from '@/components/animations';
const Features = () => {
  return (
      ...
      <div className=" md:flex-row flex-col flex w-full justify-between ">
        <Blurout>
          <h2 className=" mt-[6vh] md:mt-0 tracking-tight text-[5vw] md:text-[1.5vw]  capitalize w-[80vw] md:w-[30vw]">
            <CleanAppear>our clients are our top priority</CleanAppear>{' '}
            <CleanAppear>we’re always here for you </CleanAppear>{' '}
            <CleanAppear>deliver the best expirience.</CleanAppear>{' '}
          </h2>
        </Blurout>
        <div className="flex gap-[1vw]">
          <FeaturesAppear></FeaturesAppear>
        </div>
      </div>
    </div>
  );
